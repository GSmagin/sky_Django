...
dump_data("catalog/management/commands/fixtures/categories.json", catalog_category)
dump_data("catalog/management/commands/fixtures/products.json", catalog_product)
